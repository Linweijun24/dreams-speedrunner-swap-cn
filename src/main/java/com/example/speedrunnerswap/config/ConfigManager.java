...
public class ConfigManager {
    ...
    public String getEndGameRunnerWinTitle() {
        return getLegacyMessage("messages.end_game.runner.title", "§a§l速通者胜利！");
    }

    public String getEndGameRunnerWinRunnerSubtitle() {
        return getLegacyMessage("messages.end_game.runner.subtitle_runner", "§e哥几个状态都拉满了啊，打得真不错");
    }

    public String getEndGameRunnerWinHunterSubtitle() {
        return getLegacyMessage("messages.end_game.runner.subtitle_hunter", "§e哥几个状态都拉满了啊，打得真不错");
    }

    public String getEndGameHunterWinTitle() {
        return getLegacyMessage("messages.end_game.hunter.title", "§c§l猎人胜利！");
    }

    public String getEndGameHunterWinRunnerSubtitle() {
        return getLegacyMessage("messages.end_game.hunter.subtitle_runner", "§e你的操作我只能给到拉完了");
    }

    public String getEndGameHunterWinHunterSubtitle() {
        return getLegacyMessage("messages.end_game.hunter.subtitle_hunter", "§e这些速通者的操作真是拉完了");
    }

    public String getEndGameNoWinnerTitle() {
        return getLegacyMessage("messages.end_game.none.title", "§c§l游戏结束");
    }

    public String getEndGameNoWinnerRunnerSubtitle() {
        return getLegacyMessage("messages.end_game.none.subtitle_runner", "§e未决出胜负者");
    }

    public String getEndGameNoWinnerHunterSubtitle() {
        return getLegacyMessage("messages.end_game.none.subtitle_hunter", "§e未决出胜负者");
    }

    public String getEndGameBroadcastMessage() {
        return getLegacyMessage("messages.end_game.broadcast", "§a[速通者交换] 游戏结束 %winner%");
    }
